                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-x-10">
                        ...
                        <div className="flex flex-col gap-y-7">
                            ...
                            <div className="flex gap-x-5">
                                ...
                                <Link to="/home">
                                    <div className="w-48">
                                        <button className="w-full px-3 py-3 text-gray-900 border border-indigo-700 outline-none focus:ring-4 focus:ring-indigo-300 transition duration-500 rounded-full mb-5 ">Take Appoinment</button>
                                    </div>
                                </Link>
